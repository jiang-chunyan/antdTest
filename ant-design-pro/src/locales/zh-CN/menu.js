export default {
    ...
    'menu.onlinefile': '在线文档',
    'menu.onlinefile.preview': '文档预览',
    'menu.onlinefile.edit': '文档编辑',
    'menu.onlinefile.edit.transcode': '在线编辑',
    'menu.onlinefile.edit.transcodewait': '转码等待',
    'menu.onlinefile.edit.transcodefail': '转码失败',
    'menu.onlinefile.domain': '域名管理',
    'menu.onlinefile.domain.homepage': '域名首页',
    'menu.onlinefile.domain.setting': '域名设置',
